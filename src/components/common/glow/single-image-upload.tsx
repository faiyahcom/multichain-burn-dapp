...
const SingleImageUpload: React.FC<Props> = ({
  ...
  return (
    <>
      <div
        className={cn(
          "group relative aspect-square size-23.25! shrink-0 rounded-full border-4 border-foreground",
      ...
      >
        ...
        <label
          htmlFor={finalId}
          className={cn(
            "absolute inset-0 z-10 flex items-center justify-center rounded-full bg-black/50",
