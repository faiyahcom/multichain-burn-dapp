...
const ProfileLayout: React.FC<Props> = ({ children, classNames }) => {
  ...
  return (
    <>
      ...
      <div
        className={cn(
          "w-full rounded-md bg-[#111113] px-5.5 py-6.25 sm:rounded-24px sm:px-11 sm:py-12.75",
          classNames?.outerContainer,
        )}
      >
        <div
          className={cn(
            "w-full space-y-2.5 rounded-md bg-[#0F0F11] sm:space-y-4.75 sm:rounded-24px",
