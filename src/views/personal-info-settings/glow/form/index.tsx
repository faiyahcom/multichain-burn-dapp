...
const PersonalInfoSettingsGlowForm = () => {
  ...
  const labelClassName = "text-2xl font-medium font-inter";

  return (
    <form onSubmit={handleSubmit(onSubmit)} className="max-w-150">
      <Controller
        control={control}
        name="avatar"
        render={({ field, fieldState }) => (
          <Field
            ...
            className="mb-8.5 gap-1.25 lg:mb-13 lg:pl-7.75"
          >
      ...
      <Controller
        ...
        render={({ field, fieldState }) => (
          <Field
            data-invalid={fieldState.invalid}
            className="mb-8.75 gap-4.5 lg:mb-15.25"
          >
            <FieldLabel htmlFor={field.name} className={labelClassName}>
              Nickname
            </FieldLabel>
...
export default PersonalInfoSettingsGlowForm;
