      ...
      <DialogPortal>
            ...
            <div className="relative mb-10 flex w-full flex-col rounded-xl bg-mb-gray p-5">
              ...
              <div className="mt-1 flex w-full justify-end text-xl">
                {isLoadingBurnBalance
                  ? "Checking balance..."
                  : `${formatAmount(burnBalanceFormatted, 0)} ${
                      burnBalanceSymbol ?? burnToken?.symbol ?? ""
                    }`}
              </div>
            ...
            <div className="flex w-full flex-col rounded-xl bg-mb-gray p-5">
              ...
              <div className="mt-1 flex w-full justify-end text-xl">
                {isLoadingRewardBalance
                  ? "Checking balance..."
                  : `${formatAmount(rewardBalanceFormatted, 0)} ${
                      rewardBalanceSymbol ?? rewardToken?.symbol ?? ""
                    }`}
              </div>
            </div>
        ...
        <div
          className={`fixed transition-all duration-300 ${
            openFeePopUp ? "mt-3 max-h-40 opacity-100" : "max-h-0 opacity-0"
          }`}
        >
