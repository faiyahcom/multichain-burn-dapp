...
type MyParticipatedPoolsSwapSearchFilterState = {
  filter: ProfilePoolSearchType;
  setFilter: (filter: Partial<ProfilePoolSearchType>) => void;
};

export const useMyParticipatedPoolsSwapSearchFilterStore =
  create<MyParticipatedPoolsSwapSearchFilterState>((set) => ({
    filter: {
      page: 1,
      text: "",
